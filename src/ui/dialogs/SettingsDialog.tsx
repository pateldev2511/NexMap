...
export function SettingsDialog({
  ...
  async function clearData() {
    if (
      !confirm(
        'Delete ALL local NexMap data (autosaves + preferences)? This cannot be undone. Export your project first if you want to keep it.',
      )
    )
      return;
    try {
    ...
    <div className={styles.overlay} onClick={onClose}>
      ...
      >
        ...
        <div className={styles.body}>
          ...
          >
            <div className={styles.summary} style={{ fontWeight: 600 }}>
            ...
            <Status
              ...
              label={
                fsAvailable
                  ? 'File System Access — Save writes back to your file'
                  : 'No File System Access — Save downloads a new file each time'
              }
            />
            <Status
              ok={idbAvailable}
              label={
                idbAvailable
                  ? 'IndexedDB — autosave & recovery enabled'
                  : 'IndexedDB unavailable — autosave is OFF (export often!)'
              }
            />
            <div
              style={{ fontSize: 12, color: 'var(--chrome-fg-muted)', padding: '2px 0' }}
            >
          ...
          >
            <div className={styles.summary}>
              ...
              private window can erase autosaves — export a <code>.nexmap</code> file to
              keep work.
            </div>
            <button
